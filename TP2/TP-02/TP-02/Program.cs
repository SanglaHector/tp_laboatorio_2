...
namespace TP_02_2018
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Nombre del alumno
            Console.Title = "Sangla Héctor 2 C";
            ...
            changoDeCompras -= c1;
            Console.WriteLine("<---------- Saco 1 producto y muestro------------------->");
            Console.WriteLine(changoDeCompras.ToString());
            Console.WriteLine("<-----------PRESIONE UNA TECLA PARA CONTINUAR----------->");
            Console.ReadKey();
            Console.Clear();
            ...
            // Muestro solo Dulces
            Console.WriteLine("<---------- Solo muestro  los dulces------------------->");
            ...
            // Muestro solo Leches
            Console.WriteLine("<---------- Solo muestro  las leches------------------->");
            ...
            // Muestro solo Snacks
            Console.WriteLine("<---------- Solo muestro  las snack------------------->");
